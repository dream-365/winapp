...
namespace TISensorTag
{
    public class SensorTagIds
    {
        ...
        public const string UUID_ACC_SERV = "f000aa10-0451-4000-b000-000000000000";
        public const string UUID_ACC_DATA = "f000aa11-0451-4000-b000-000000000000";
        public const string UUID_ACC_CONF = "f000aa12-0451-4000-b000-000000000000";
        public const string UUID_ACC_PERI = "f000aa13-0451-4000-b000-000000000000";
        ...
        public const string UUID_MAG_SERV = "f000aa30-0451-4000-b000-000000000000";
        public const string UUID_MAG_DATA = "f000aa31-0451-4000-b000-000000000000";
        public const string UUID_MAG_CONF = "f000aa32-0451-4000-b000-000000000000";
        public const string UUID_MAG_PERI = "f000aa33-0451-4000-b000-000000000000";
        ...
        public const string UUID_GYR_SERV = "f000aa50-0451-4000-b000-000000000000";
        public const string UUID_GYR_DATA = "f000aa51-0451-4000-b000-000000000000";
        public const string UUID_GYR_CONF = "f000aa52-0451-4000-b000-000000000000";
        public const string UUID_GYR_PERI = "f000aa53-0451-4000-b000-000000000000";
